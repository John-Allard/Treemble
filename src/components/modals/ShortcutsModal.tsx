            ...
            >
                ...
                <table style={{ width: "100%", fontSize: "0.9em", textAlign: "left" }}>
                    <tbody>
                        ...
                        <tr>
                            <td style={{ verticalAlign: "top" }}><strong>Shift+Click</strong></td>
                            <td>Connect node to selected parent. Assigning 3 or more nodes to one parent allows polytomies to be specified.</td>
                        </tr>
                    </tbody>
                </table>
